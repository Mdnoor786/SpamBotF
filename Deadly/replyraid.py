...
if UstaD:
 @UstaD.on(events.NewMessage(pattern="/stopraid"))
 async def _(e):
    global que    
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
...
if UstaD2:
 @UstaD2.on(events.NewMessage(pattern="/stopraid"))
 async def _(e):
    global que    
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
...
if UstaD3:
 @UstaD3.on(events.NewMessage(pattern="/stopraid"))
 async def _(e):
    global que    
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
...
if UstaD4:
 @UstaD4.on(events.NewMessage(pattern="/stopraid"))
 async def _(e):
    global que    
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
...
if UstaD5:
 @UstaD5.on(events.NewMessage(pattern="/stopraid"))
 async def _(e):
    global que    
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
...
if UstaD6:
 @UstaD6.on(events.NewMessage(pattern="/stopraid"))
 async def _(e):
    global que    
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
...
if UstaD7:
 @UstaD7.on(events.NewMessage(pattern="/stopraid"))
 async def _(e):
    global que    
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
...
if UstaD8:
 @UstaD8.on(events.NewMessage(pattern="/stopraid"))
 async def _(e):
    global que    
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
...
if UstaD9:
 @UstaD9.on(events.NewMessage(pattern="/stopraid"))
 async def _(e):
    global que    
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
...
if UstaD10:
 @UstaD10.on(events.NewMessage(pattern="/stopraid"))
 async def _(e):
    global que    
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
